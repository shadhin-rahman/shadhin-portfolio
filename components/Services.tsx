            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16 md:mb-20">
                <div>
                    ...
                    <h3 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.15] logo-text">
                        Core{" "}
                        <span className="text-brand-700 dark:text-brand-400">specialties.</span>
                    </h3>
                </div>
                <div className="flex flex-col gap-4 items-start md:items-end">
                    ...
                    {showCta && (
                        <a
                            href="/services"
                            className="inline-flex items-center gap-2 px-7 py-3.5 rounded-full bg-brand-400 text-black font-bold hover:bg-brand-500 transition-colors shadow-lg shadow-brand-400/30 group"
                        >
                            View All Services
                    ...
                    >
                        <div>
                            <div className="flex items-center justify-between mb-8">
                                <div className="w-12 h-12 rounded-full bg-brand-100 dark:bg-brand-400/15 flex items-center justify-center group-hover:bg-brand-400 transition-colors duration-500">
                                    <CheckCircle2 className="w-6 h-6 text-brand-700 dark:text-brand-400 group-hover:text-black transition-colors duration-500" />
                                </div>
                                <span className="font-mono text-xs font-bold tracking-[0.2em] text-[#1d1b16]/30 dark:text-white/30 group-hover:text-brand-700 dark:group-hover:text-brand-400 transition-colors duration-500">
                        ...
                        <div className="mt-10 h-1 w-full rounded-full bg-black/5 dark:bg-white/10 group-hover:bg-brand-400 transition-colors duration-700" />
                    </motion.div>
                ))}
            </div>
        </section>
