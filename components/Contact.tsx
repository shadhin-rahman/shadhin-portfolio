        ...
        <section id="contact" className="scroll-mt-32 max-w-7xl mx-auto px-6 pb-20 md:pb-28">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-20 items-start border-t border-black/10 dark:border-white/10 pt-20 md:pt-24">
                ...
                <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-8">
                    <div>
                        <h2 className="text-brand-700 dark:text-brand-300 font-mono text-sm tracking-[0.5em] uppercase mb-6 font-bold">
                            Get In Touch
                        </h2>
                        <h3 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.15] mb-8 logo-text text-[#1d1b16] dark:text-[#f5f2ec]">
                            Let's create something <span className="text-brand-700 dark:text-brand-300">iconic.</span>
                        </h3>
                    ...
                    <div className="flex flex-col gap-5 text-lg text-[#1d1b16]/80 dark:text-white/80">
                        <div className="flex items-center gap-3">
                            <span className="w-11 h-11 rounded-full bg-brand-100 dark:bg-brand-300/15 flex items-center justify-center">
                                <Phone className="w-5 h-5 text-brand-700 dark:text-brand-300" />
                            </span>
                            <span>{portfolioData.contact.phone}</span>
                        </div>
                        <div className="flex items-center gap-3">
                            <span className="w-11 h-11 rounded-full bg-brand-100 dark:bg-brand-300/15 flex items-center justify-center">
                                <Mail className="w-5 h-5 text-brand-700 dark:text-brand-300" />
                            </span>
