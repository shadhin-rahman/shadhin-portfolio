        ...
        <section id="education" className="scroll-mt-32 max-w-7xl mx-auto px-6 py-24 md:py-32">
            <div className="text-center mb-16 md:mb-20">
                ...
                <h3 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.2] logo-text">
                    Education & <span className="text-brand-700 dark:text-brand-300">training.</span>
                </h3>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                ...
                <div className="bg-white dark:bg-white/[0.03] rounded-[2.5rem] border border-black/10 dark:border-white/10 p-8 md:p-10">
                    <div className="flex items-center gap-4 mb-10">
                        <div className="p-3 bg-brand-100 dark:bg-brand-300/15 rounded-2xl text-brand-700 dark:text-brand-300">
                    ...
                    <div className="space-y-10 border-l-2 border-black/10 dark:border-white/10 pl-8 ml-2">
                        {portfolioData.education?.academic.map((edu, index) => (
                            <motion.div
                                ...
                                className="relative"
                            >
                                <div className="absolute -left-[38px] top-1.5 w-3.5 h-3.5 rounded-full bg-brand-300 border-[3px] border-white dark:border-[#141210] shadow" />
                    ...
                    <div className="space-y-10 border-l-2 border-black/10 dark:border-white/10 pl-8 ml-2">
                        {portfolioData.education?.training.map((train, index) => (
                            ...
                            >
                                ...
                                {train.year && (
                                    <span className="inline-block mt-3 text-xs font-bold text-brand-800 dark:text-brand-300 font-mono bg-brand-100 dark:bg-brand-300/15 px-3 py-1 rounded-full">
                                        {train.year}
                                    </span>
                                )}
                            </motion.div>
